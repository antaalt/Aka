...
void Shader::setMatrix4(const char* name, const mat4f& value, bool transpose)
{
	glUniformMatrix4fv(getUniformLocation(name), 1, transpose, &value.cols[0].x);
}
